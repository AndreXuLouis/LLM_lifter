...
if __name__ == '__main__':
    ...
    init_prompts = [
        {
            "role": "system",
            "content": """ You will be provided with x86-64 assembly code (generated by IDAPro) about a program.
            ...
            2. Follow LLVM's SSA variable naming conventions. When a variable's value comes from different branches, a PHI node must be used. \
            e.g. %3 = phi [%0, %bb.0], [%1, %bb.1]
            3. Use LLVM numeric labels such as %0, %1.
            """
            # Output Format Requirements:
    ...
    openai.api_request_timeout = 10000  # 超时时间为3600s
    ...
    origin_response = response_result.choices[0].message.content
    # data = json.loads(origin_response)
    # llvm_ir = data["lift_json"]
    llvm_ir = origin_response
