...
**tmpfiles/**：提升过程产生的临时文件，包括二进制文件，反汇编结果（以`.x86_asm`结尾的文件），提升结果（以`-llm-dis.ll`结尾的文件）等文件
...
注：使用openai API需要联网，需要反向代理，反向代理方法见：[反向代理指令](http://10.208.129.35:8090/pages/viewpage.action?pageId=27099463)
